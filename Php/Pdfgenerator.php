...
$pdf->SetAuthor('Bastiaan van Kleef');
$pdf->SetTitle('Offerte');
$pdf->SetSubject('Offerte Elst Klusbedrijf - Klant');
$pdf->SetKeywords('Offerte, PDF, Elst, Klusbedrijf, Klant');
